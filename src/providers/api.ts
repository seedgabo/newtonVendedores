...
export class Api {
    ...
    initVar() {
        ...
        // this.storage.get("user").then( (data)      =>  data!=undefined ? this.user = JSON.parse(data): undefined );
        this.storage.get("carrito").then((data) => data != undefined ? this.carrito = JSON.parse(data) : []);
        this.storage.get("clientes").then((data) => data != undefined ? this.clientes = JSON.parse(data) : []);
        this.storage.get("cliente").then((data) => data != undefined ? this.cliente = JSON.parse(data) : []);
    }
